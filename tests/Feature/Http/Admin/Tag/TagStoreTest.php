...
class TagStoreTest extends BaseIntegrationTesting
{
    use HasDummyTag;
    ...
    public function test_if_cant_see_if_user_is_unauthenticated(): void
    {
        ...
        $this->postJson(route('tags.store'), $this->getValidPayload())
            ->assertUnauthorized()
    ...
    public function test_if_cant_see_if_hasnt_permissions(): void
    {
        ...
        $this->postJson(route('tags.store'), $this->getValidPayload())->assertNotFound();
    }
    ...
    {
        $this->postJson(route('tags.store'))->assertUnprocessable();
    }
    ...
    /**
     * Test if can't create a duplicated tag.
     *
     * @return void
     */
    public function test_if_cant_create_a_duplicated_tag(): void
    {
    ...
    public function test_if_can_log_context_on_tag_creation_failure(): void
    {
        ...
        $logServiceMock->shouldReceive('withContext')
            ...
            ->with(
                Mockery::on(function (string $title) {
                    return $title === 'Failed to create a new tag.';
                }),
        ...
        $tagServiceMock->shouldReceive('create')
            ->once()
            ->andThrow($exception);
    ...
    {
        $this->postJson(route('tags.store'), $this->getValidPayload())->assertCreated();
    }
    ...
    {
        $this->postJson(route('tags.store'), $data = $this->getValidPayload())->assertCreated();
    ...
    {
        $this->postJson(route('tags.store'), $this->getValidPayload())->assertCreated()->assertJsonStructure([
            'data' => [
                'id',
                'name',
                'slug',
    ...
    {
        $this->postJson(route('tags.store'), $data = $this->getValidPayload())->assertCreated()->assertJson([
            'data' => [
                'name' => $data['name'],
            ],
        ]);
