...
use App\Http\Requests\Admin\Protection\ProtectionUpdateRequest;

class ProtectionUpdateRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return ProtectionUpdateRequest::class;
    }
