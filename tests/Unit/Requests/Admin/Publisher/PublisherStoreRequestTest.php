...
use App\Http\Requests\Admin\Publisher\PublisherStoreRequest;

class PublisherStoreRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return PublisherStoreRequest::class;
    }
