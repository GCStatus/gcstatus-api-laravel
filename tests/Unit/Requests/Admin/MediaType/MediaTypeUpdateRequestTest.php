...
use App\Http\Requests\Admin\MediaType\MediaTypeUpdateRequest;

class MediaTypeUpdateRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return MediaTypeUpdateRequest::class;
    }
