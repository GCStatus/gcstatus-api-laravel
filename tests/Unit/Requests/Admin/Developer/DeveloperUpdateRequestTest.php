...
namespace Tests\Unit\Requests\Admin\Developer;

use Tests\Traits\HasDummyDeveloper;
use PHPUnit\Framework\Attributes\DataProvider;
use Tests\Contracts\Requests\BaseRequestTesting;
use Illuminate\Foundation\Testing\RefreshDatabase;
use App\Http\Requests\Admin\Developer\DeveloperUpdateRequest;

class DeveloperUpdateRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return DeveloperUpdateRequest::class;
    }
