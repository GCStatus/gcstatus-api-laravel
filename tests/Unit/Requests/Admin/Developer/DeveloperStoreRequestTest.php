...
use App\Http\Requests\Admin\Developer\DeveloperStoreRequest;

class DeveloperStoreRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return DeveloperStoreRequest::class;
    }
