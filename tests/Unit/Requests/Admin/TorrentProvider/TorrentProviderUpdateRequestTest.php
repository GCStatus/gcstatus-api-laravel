...
use App\Http\Requests\Admin\TorrentProvider\TorrentProviderUpdateRequest;

class TorrentProviderUpdateRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return TorrentProviderUpdateRequest::class;
    }
