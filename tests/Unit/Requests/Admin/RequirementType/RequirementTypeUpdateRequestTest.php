...
use Tests\Traits\HasDummyRequirementType;
use PHPUnit\Framework\Attributes\DataProvider;
use Tests\Contracts\Requests\BaseRequestTesting;
use Illuminate\Foundation\Testing\RefreshDatabase;
use App\Http\Requests\Admin\RequirementType\RequirementTypeUpdateRequest;

class RequirementTypeUpdateRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return RequirementTypeUpdateRequest::class;
    }

    /**
     * Test if can validate composite unique validation on update.
     *
     * @return void
     */
