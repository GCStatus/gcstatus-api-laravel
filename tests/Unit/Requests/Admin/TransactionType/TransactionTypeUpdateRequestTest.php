...
use App\Http\Requests\Admin\TransactionType\TransactionTypeUpdateRequest;

class TransactionTypeUpdateRequestTest extends BaseRequestTesting
{
    use RefreshDatabase;
    ...
    {
        return TransactionTypeUpdateRequest::class;
    }
