...
use App\Http\Resources\Admin\StoreableResource;
...
class StoreableResourceTest extends BaseResourceTesting
{
    ...
    public function modelInstance(): Storeable
    {
        ...
        $storeableMock->shouldReceive('getAttribute')->with('created_at')->andReturn(fake()->date());
        $storeableMock->shouldReceive('getAttribute')->with('updated_at')->andReturn(fake()->date());
