...
use Mockery;
use App\Http\Resources\Admin\TorrentResource;
...
class TorrentResourceTest extends BaseResourceTesting
{
    ...
    public function modelInstance(): Torrent
    {
        ...
        $torrentMock->shouldReceive('getAttribute')->with('created_at')->andReturn(fake()->date());
        $torrentMock->shouldReceive('getAttribute')->with('updated_at')->andReturn(fake()->date());
