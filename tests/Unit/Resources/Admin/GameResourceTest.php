...
class GameResourceTest extends BaseResourceTesting
{
    ...
    public function modelInstance(): Game
    {
        ...
        $gameMock->shouldReceive('getAttribute')->with('comments_count')->andReturn(fake()->numberBetween(1, 999));
        $gameMock->shouldReceive('getAttribute')->with('condition')->andReturn(fake()->randomElement(['hot', 'popular', 'sale', 'common']));
