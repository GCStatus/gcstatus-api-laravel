...
use App\Http\Resources\Admin\CriticableResource;
...
class CriticableResourceTest extends BaseResourceTesting
{
    ...
    public function modelInstance(): Criticable
    {
        ...
        $criticableMock->shouldReceive('getAttribute')->with('created_at')->andReturn(fake()->date());
        $criticableMock->shouldReceive('getAttribute')->with('updated_at')->andReturn(fake()->date());
